...
# Generated: Sun Oct 29 14:33:10 2017
##################################################
...
class minimal_working_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, samp_rate*10,True)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.bitstream_permutation_source_b_0 = bitstream.bitstream_permutation_source_b(
            min_value=0,
            max_value=3,
            value_range=([]),
            seq_length=8,
        ...
        # Connections
        ##################################################
        self.connect((self.bitstream_permutation_source_b_0, 0), (self.blocks_throttle_0, 0))
